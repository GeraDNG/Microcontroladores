//LibrerÌa para controlar la matriz de leds
...
void MandaMax7219DosMatrices(unsigned long int dato)
{
    unsigned char i;
    CLK=0;    
    LOAD=0;
...
void ConfiguraMax2(void)
{
    DDRC|=0x07;
    MandaMax7219DosMatrices(0x09000900);
    MandaMax7219DosMatrices(0x0A0B0A0B);
    MandaMax7219DosMatrices(0x0B070B07);
    MandaMax7219DosMatrices(0x0C010C01);
    MandaMax7219DosMatrices(0x0F000F00);
}
...
//Letras para la generaciÛn de las letras. Existe un desfasamiento de 32
